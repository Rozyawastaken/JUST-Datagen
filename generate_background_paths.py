...
if __name__ == '__main__':
    ...
    with open('E:\\SRNet_bg_images\\SynthText\\bg_data\\imnames.cp', 'rb') as file:
        data = pickle.load(file)

    output_path = 'E:\\SRNet_bg_images\\SynthText\\bg_data\\bg_img'  # Update to your output directory
