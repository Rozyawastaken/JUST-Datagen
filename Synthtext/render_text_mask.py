...
#                 x += space.width
#             elif ch in ("э", "Э"):
#                 ch_bounds = font.get_rect(ch)
#                 ch_surf = pygame.Surface((ch_bounds.width, ch_bounds.height), pygame.SRCALPHA)
#                 font.render_to(ch_surf, (0, 0), ch)
#                 ch_surf = pygame.transform.flip(ch_surf, True, False)
...
#     rect = font.get_rect(text[mid_idx])
#     rect.centerx = surf.get_rect().centerx
#     rect.centery = surf.get_rect().centery + rect.height + curve[mid_idx]
#
#     if text[mid_idx] in ("э", "Э"):
#         ch_bounds = font.get_rect(text[mid_idx])
#         ch_surf = pygame.Surface((ch_bounds.width, ch_bounds.height), pygame.SRCALPHA)
#         font.render_to(ch_surf, (0, 0), text[mid_idx])
#         ch_surf = pygame.transform.flip(ch_surf, True, False)
#         surf.blit(ch_surf, rect.topleft)
#         ch_bounds.x = rect.x
#         ch_bounds.y = rect.y
#     else:
#         ch_bounds = font.render_to(surf, rect, text[mid_idx], rotation=rots[mid_idx])
...
#             font.render_to(ch_surf, (0, 0), ch)
#             try:
#                 font.render_to(ch_surf, (0, 0), ch, rotation=rots[i])
#             except ValueError:
#                 font.render_to(ch_surf, (0, 0), ch)
#             ch_surf = pygame.transform.flip(ch_surf, True, False)
#             surf.blit(ch_surf, newrect.topleft)
#             ch_bounds.x = newrect.x
#             ch_bounds.y = newrect.y
#         else:
#             try:
#                 ch_bounds = font.render_to(surf, newrect, ch, rotation=rots[i])
#             except ValueError:
#                 ch_bounds = font.render_to(surf, newrect, ch)
#             ch_bounds.x = newrect.x + ch_bounds .x
#             ch_bounds.y = newrect.y - ch_bounds .y
#
#         bbs.append(np.array(ch_bounds))
#         last_rect = newrect
#
